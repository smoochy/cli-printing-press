...
func TestMergeIntoFreshTreeKeepsHandEditedFuncWhenSnapshotDiffersFromOriginal(t *testing.T) {
	t.Parallel()
	...
	write(base, `func Shared() string { return "orig" }
`)
...
func TestMergeIntoFreshTreeTakesFreshFuncWhenSnapshotMatchesOriginal(t *testing.T) {
	t.Parallel()
	...
	write(base, `func Shared() string { return "orig" }
`)
	write(snap, `func Shared() string { return "orig" }
`)
	write(fresh, `func Shared() string { return "fresh" }
`)
	...
	assert.Contains(t, string(got), `return "fresh"`,
		"an unpatched shared body must keep the regenerated emission")
	assert.NotContains(t, string(got), `return "orig"`)
}
