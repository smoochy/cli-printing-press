...
func TestFindPII_Email(t *testing.T) {
	tests := []struct {
		...
		{name: "go-toolchain-module", line: `golang.org/toolchain@v0.0.1-go1.26.8.darwin-amd64`, expectKinds: nil},
		{name: "go-toolchain-detected-span-without-context", line: `toolchain@v0.0.1-go1.26.8.darwin`, expectKinds: []string{PIIKindEmail}},
		{name: "go-toolchain-missing-architecture", line: `golang.org/toolchain@v0.0.1-go1.26.8.darwin`, expectKinds: []string{PIIKindEmail}},
		{name: "go-toolchain-wrong-prefix", line: `example.org/toolchain@v0.0.1-go1.26.8.darwin-amd64`, expectKinds: []string{PIIKindEmail}},
		{name: "toolchain-real-email-still-flags", line: `toolchain@company.com`, expectKinds: []string{PIIKindEmail}},
		{name: "toolchain-version-domain-other-user-still-flags", line: `person@v0.0.1-go1.26.8.darwin`, expectKinds: []string{PIIKindEmail}},
